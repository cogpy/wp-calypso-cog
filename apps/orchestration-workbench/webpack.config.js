...
const outBasePath = process.env.ORCHESTRATION_WORKBENCH_PACKAGE_PATH
	? process.env.ORCHESTRATION_WORKBENCH_PACKAGE_PATH
	: __dirname;
...
module.exports = {
	...
	plugins: [
		...
		new webpack.DefinePlugin( {
			__i18n_text_domain__: JSON.stringify( 'orchestration-workbench' ),
		} ),
