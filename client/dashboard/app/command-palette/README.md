...
The command palette will only register commands for features that are enabled in the current dashboard configuration. This allows different dashboards (e.g., `/manage` vs `/v2-a4a`) to show different commands without code duplication.
